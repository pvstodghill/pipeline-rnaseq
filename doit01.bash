...
(
	...
	echo falco -q -o ${FALCO1}/${SAMPLES_NAME[$i]}_R1 ${INPUTS}/raw_${SAMPLES_NAME[$i]}_R1.fastq.gz
	if [ "$PE" ] ; then
	    mkdir -p ${FALCO1}/${SAMPLES_NAME[$i]}_R2
	    echo falco -q -o ${FALCO1}/${SAMPLES_NAME[$i]}_R2 ${INPUTS}/raw_${SAMPLES_NAME[$i]}_R2.fastq.gz
	fi
    done
